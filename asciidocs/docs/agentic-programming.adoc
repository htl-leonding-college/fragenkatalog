...
[IMPORTANT]
====
*Modellauswahl beeinflusst die Ergebnisqualität erheblich!*

Die meisten KI-Coding-Tools erlauben den Wechsel des Backend-Modells über `/model` oder in den Einstellungen. Leistungsfähigere Modelle liefern bessere Ergebnisse bei:
...
2. Ja, verwende das Builder Pattern für die Bestellung-Entity
