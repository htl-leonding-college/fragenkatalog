...
TIP: Verwende den *Plan Mode* (`/plan`) für komplexe Implementierungen – Claude zeigt dann zuerst einen Umsetzungsplan zur Bestätigung. Siehe <<Plan Mode>> in den Best Practices.
...
==== Zusammenspiel mit unserem Workflow
...
TIP: Besonders bei komplexen User Stories oder Refactorings `/plan` verwenden. Bei einfachen Fixes (Typos, kleine Änderungen) ist der Plan Mode optional.
