...
=== git in Teams [.badge.foundation data-level=foundation]#Foundation#
...
=== `.gitignore` [.badge.foundation data-level=foundation]#Foundation#

* Was bewirkt ein Eintrag in der Datei `.gitignore`? Warum ist es wichtig, `.gitignore` zu verwenden?

=== ssh in github [.badge.foundation data-level=foundation]#Foundation#
...
=== gh-pages aktivieren [.badge.foundation data-level=foundation]#Foundation#
...
=== git Konfiguration 1 [.badge.foundation data-level=foundation]#Foundation#
...
=== git Konfiguration 2 [.badge.foundation data-level=foundation]#Foundation#
...
=== git Konfiguration 3 [.badge.foundation data-level=foundation]#Foundation#
...
=== git Konfiguration 4 [.badge.foundation data-level=foundation]#Foundation#
...
=== git Konfiguration 5 [.badge.foundation data-level=foundation]#Foundation#
...
=== git Konfiguration 6 [.badge.foundation data-level=foundation]#Foundation#
